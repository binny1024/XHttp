package com.binny.core.xhttp;


import android.text.TextUtils;
import android.util.Log;

import com.binny.sdk.core.splash.constant.ErrorCode;
import com.binny.core.xhttp.callback.OnXHttpCallback;
import com.binny.core.xhttp.core.task.HttpTask;
import com.binny.core.logger.JJLogger;
import com.binny.core.xhttp.core.IHttp;
import com.binny.core.xhttp.core.pool.IThreadPool;
import com.binny.core.xhttp.core.pool.ThreadPool;
    ...
    public XHttp setOnXHttpCallback(final OnXHttpCallback taskCallback) {
        ...
        if (mStartSerailThreadPool && sSerialThreadPool != null) {
            ...
            if (sSerialThreadPool.isShutdownPool() || sSerialThreadPool.isShutdownPool()) {
                JJLogger.logInfo(TAG, "XHttp.parseStream : 线程池已关闭 错误码：" + ErrorCode.CODE_CANCLE);
                return mInstance;
            }
            try {
                sSerialThreadPool.start(mHttpTask);
            } catch (RejectedExecutionException e) {
                JJLogger.logInfo(TAG, "XHttp.parseStream :" + sCurrentThreadPool.getCount());
            }
