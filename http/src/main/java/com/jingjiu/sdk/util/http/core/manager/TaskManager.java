package com.jingjiu.sdk.util.http.core.manager;
...
import com.jingjiu.sdk.util.http.core.IThreadPoolSettings;
import com.jingjiu.sdk.util.http.core.pool.ThreadPool;
import com.jingjiu.sdk.util.http.core.task.HttpTask;
