...
import static com.jingjiu.sdk.core.ad.common.Configuration.HANDLER;
import static com.jingjiu.sdk.core.ad.common.ErrorCode.CODE_CANCLE;
import static com.jingjiu.sdk.core.ad.common.ErrorCode.CODE_CONNECT;
import static com.jingjiu.sdk.core.ad.common.ErrorCode.CODE_CONNECT_UNKNOWN_HOST;
import static com.jingjiu.sdk.core.ad.common.ErrorCode.CODE_REQUEST_URL;
import static com.jingjiu.sdk.core.ad.common.ErrorCode.CODE_TIME_OUT;
import static com.jingjiu.sdk.util.CommonMethod.getAdAppInfo;
import static com.jingjiu.sdk.util.CommonMethod.toByteArray;
...
/*    @Override
    public IHttpTask openProxy(final boolean open) {
        mIsproxy = open;
        return this;
    }*/
    ...
    public void run() {
        ...
        try {
            ...
            URL httpUrl = new URL(mUrl);
             JJLogger.logInfo(TAG,"HttpTask.run :"+mIsproxy);
            if(mIsproxy){//使用代理模式
                final String proxyHost = getAdAppInfo().metaData.getString("HOST");
                final int proxyPort = getAdAppInfo().metaData.getInt("PORT");
                if (proxyPort == 0 ||proxyHost == null) {
                    httpUrlCon = (HttpURLConnection) httpUrl.openConnection();
                }else {
                     JJLogger.logInfo(TAG,"HttpTask.run :"+proxyHost +": "+proxyPort);
                    @SuppressWarnings("static-access")
                    Proxy proxy = new Proxy(Proxy.Type.DIRECT.HTTP, new InetSocketAddress(proxyHost, proxyPort));
                    httpUrlCon = (HttpURLConnection) httpUrl.openConnection(proxy);
                }
            }else{
                httpUrlCon = (HttpURLConnection) httpUrl.openConnection();
            }
